export default class UI {
  constructor(dashboardManager) {
    ...
    if (!this.dashboard) throw "Invalid HTML template";
  ...
  parseInputs() {
    ...
    const updateInterval = parseInt(
      this.inputEl.querySelector(".update-interval select").value
    );
    const maxHeatmapSize = parseInt(
      this.inputEl.querySelector(".heatmap-size select").value
    );
    const levels = parseInt(this.inputEl.querySelector(".levels select").value);
    const aggregation = parseInt(
      this.inputEl.querySelector(".aggregation select").value
    );
